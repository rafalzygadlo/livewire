                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('user.home') }}"> @lang('home.link')</a>
                                <a class="dropdown-item" href="{{ route('user.settings') }}">@lang('settings.link')</a>
                                <a class="dropdown-item" href="{{ route('user.profile') }}">@lang('profile.link')</a>
